...
unsigned char MY[10];
unsigned static int dest=0,del=700;             //setting default values for destination address and delay
...
{                                   //main code to run repeatedly
    ...
    char charBuff[len];
    pkt_broadcast(&charBuff[0]);
    jsonString.toCharArray(charBuff,len-1);
